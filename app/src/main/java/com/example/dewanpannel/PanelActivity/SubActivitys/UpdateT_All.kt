...
import com.example.dewanpannel.databinding.ActivityUpdateTallBinding
...
class UpdateT_All : AppCompatActivity() {
    private lateinit var binding:ActivityUpdateTallBinding
    private lateinit var auth:FirebaseAuth
    private lateinit var databaseReference: DatabaseReference
    private lateinit var storageReference: StorageReference
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityUpdateTallBinding.inflate(layoutInflater)
        setContentView(binding.root)
        auth = FirebaseAuth.getInstance()
        databaseReference = FirebaseDatabase.getInstance().getReference("Updates  Teachers to All")
        storageReference = FirebaseStorage.getInstance().getReference("Updates  Teachers to All")
