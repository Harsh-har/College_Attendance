...
import com.example.dewanpannel.databinding.ActivityUpdateDallBinding
...
class UpdateD_All : AppCompatActivity() {
    private lateinit var binding: ActivityUpdateDallBinding
    private lateinit var auth: FirebaseAuth
    private lateinit var databaseReference: DatabaseReference
    private lateinit var storageReference: StorageReference
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=  ActivityUpdateDallBinding.inflate(layoutInflater)
        setContentView(binding.root)
        auth = FirebaseAuth.getInstance()
        databaseReference = FirebaseDatabase.getInstance().getReference("Updates  Directors to All")
        storageReference = FirebaseStorage.getInstance().getReference("Updates  Directors to All")
